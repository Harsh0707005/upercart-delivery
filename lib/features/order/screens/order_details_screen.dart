...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  void changeStatus(ordercon, order, status) {
    order.updateOrderStatus(ordercon, status,
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: GetBuilder<OrderController>(builder: (orderController) {
              ...
              if (controllerOrderModel?.orderStatus != null &&
                  selectedStatus == null &&
                  ["confirmed", "handover", "picked_up", "delivered"]
                      .contains(controllerOrderModel?.orderStatus)) {
                selectedStatus = controllerOrderModel?.orderStatus!.tr;
              }

              return (orderController.orderDetailsModel != null &&
                      controllerOrderModel != null && !isLoading)
                  ? Column(children: [
                      Expanded(
